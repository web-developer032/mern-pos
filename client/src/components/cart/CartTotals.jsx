...
const CartTotals = () => {
  ...
  return (
    <div className="cart h-full max-h-[calc(100vh_-_90px)] flex flex-col">
      <h2 className="bg-blue-600 text-white p-4 font-bold tracking-wide">Products in Basket</h2>
            ...
            .map((item) => (
              <li className="cart-item flex justify-between" key={item._id}>
                ...
                <div className="flex items-center">
                  ...
                  />
                  <span className="font-bold inline-block w-6 text-center">{item.quantity}</span>
                  <Button
                    type="primary"
                    size="small"
                    className="w-full flex items-center justify-center !rounded-full"
